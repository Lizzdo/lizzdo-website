        ...
        <div className="container mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {projects.length > 0 ? projects.map((project: any) => (
              ...
              >
                <Link to={`/portfolio/${project.slug}`} className="block aspect-video bg-black/50 relative overflow-hidden">
                  <img 
                    src={project.thumbnail || "/lizzdo-logo.png"} 
                    alt={project.title} 
              ...
              posts.map((post: any, i: number) => (
                ...
                >
                  <Link to={`/blog/${post.slug}`} className="block aspect-video overflow-hidden relative">
                    <img 
                      src={post.thumbnail || "/lizzdo-logo.png"} 
                      alt={post.title} 
