                ...
                {relatedProjects.map((p) => (
                  <Link key={p.slug} to={`/portfolio/${p.slug}`} className="group flex flex-col glass-panel rounded-2xl overflow-hidden border border-white/5 bg-slate-950 hover:border-white/20 transition-all">
                    <div className="aspect-video w-full relative overflow-hidden bg-black">
                      <img src={p.image} alt={p.title} className="absolute inset-0 w-full h-full object-cover transition-transform duration-700 group-hover:scale-105 opacity-80 group-hover:opacity-100" />
                    </div>
